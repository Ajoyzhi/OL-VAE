...
kdd99_vae = VAE_KDD99()
# 创建trainer，并训练网络
kdd99_vae_trainer = VAE_Kdd99_trainer(net=kdd99_vae, trainloader=kdd99_train_loader, testloader=kdd99_test_loader, epochs=50, sample_num=10)
kdd99_vae_trainer.train()
kdd99_vae_trainer.get_normal_parm()
# 测试算法性能
kdd99_vae_trainer.test()
acc, pre, recall, FPR, MCC = metric(kdd99_vae_trainer.index_label_prediction)
print("acc:", acc,
      "pre:", pre,
      "recall:", recall,
      "FPR:", FPR,
